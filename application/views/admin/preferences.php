            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="emoji_reactions_1" name="emoji_reactions" value="1" class="square-purple" <?php echo ($general_settings->emoji_reactions == "1") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="show_rss_1" name="show_rss" value="1" class="square-purple" <?php echo ($general_settings->show_rss == "1") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="newsletter_1" name="newsletter" value="1" class="square-purple" <?php echo ($general_settings->newsletter == "1") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="show_newsticker_1" name="show_newsticker" value="1" class="square-purple" <?php echo ($general_settings->show_newsticker == "1") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="show_hits_1" name="show_hits" value="1" class="square-purple" <?php echo ($general_settings->show_hits == "1") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="sort_slider_posts_1" name="sort_slider_posts" value="by_slider_order" class="square-purple" <?php echo ($general_settings->sort_slider_posts == "by_slider_order") ? 'checked' : ''; ?>>
                            <label for="sort_slider_posts_1" class="cursor-pointer"><?php echo trans('by_slider_order'); ?></label>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="sort_slider_posts_2" name="sort_slider_posts" value="by_date" class="square-purple" <?php echo ($general_settings->sort_slider_posts == "by_date") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="sort_featured_posts_1" name="sort_featured_posts" value="by_featured_order" class="square-purple" <?php echo ($general_settings->sort_featured_posts == "by_featured_order") ? 'checked' : ''; ?>>
                            <label for="sort_featured_posts_1" class="cursor-pointer"><?php echo trans('by_featured_order'); ?></label>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="sort_featured_posts_2" name="sort_featured_posts" value="by_date" class="square-purple" <?php echo ($general_settings->sort_featured_posts == "by_date") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="approve_added_user_posts_1" name="approve_added_user_posts" value="1" class="square-purple" <?php echo ($general_settings->approve_added_user_posts == "1") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="approve_updated_user_posts_1" name="approve_updated_user_posts" value="1" class="square-purple" <?php echo ($general_settings->approve_updated_user_posts == "1") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="file_manager_show_files_1" name="file_manager_show_files" value="1" class="square-purple" <?php echo ($general_settings->file_manager_show_files == "1") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="number" class="form-control" name="pagination_per_page" value="<?php echo html_escape($general_settings->pagination_per_page); ?>" min="1" max="3000" required style="max-width: 450px;">
                        </div>
                    </div>
                </div>
