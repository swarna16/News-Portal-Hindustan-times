        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="pull-left">
                            <button class="btn btn-sm btn-danger btn-table-delete" onclick="delete_selected_comments('<?php echo trans("confirm_comments"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
