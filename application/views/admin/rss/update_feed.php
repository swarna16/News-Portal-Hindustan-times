        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($feed->image_mid)): ?>
                        <div class="row">
                            <div class="col-sm-12">
                                <img src="<?php echo base_url() . $feed->image_mid; ?>" alt="" style="max-width: 240px; max-height: 240px; float: left;margin-right: 10px;">
                                <button type="button" class="btn btn-sm btn-danger" onclick="delete_rss_feed_image(<?php echo $feed->id; ?>);"><?php echo trans("delete"); ?></button>
                            </div>
                        </div>
                    <?php endif; ?>
