                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="post-items-item post-items-item-table">
                            ...
                            <div class="buttons">
                                <a href="<?php echo admin_url(); ?>ordered-list-items/<?php echo $post_item->post_id; ?>?edit_item_id=<?php echo $post_item->id; ?>" class="btn btn-sm btn-warning m-r-5"><i class="fa fa-pencil"></i>&nbsp;&nbsp;<?php echo trans("edit"); ?></a>
                                <button type="button" class="btn btn-sm btn-danger" onclick="delete_ordered_list_item('<?php echo $post_item->id; ?>','<?php echo trans("confirm_item"); ?>');"><i class="fa fa-trash"></i>&nbsp;&nbsp;&nbsp;<?php echo trans("delete"); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
