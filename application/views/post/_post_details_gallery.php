...
<?php if ($gallery_post_total_item_count > 0): ?>
    <div class="gallery-post-item">
        ...
        <div class="gallery-post-buttons">
            <?php if ($gallery_post_item_order != 1): ?>
                <a href="<?php echo post_url($post); ?>/<?php echo($gallery_post_item_order - 1); ?>" class="btn btn-custom btn-md pull-left"><i class="icon-arrow-left"></i> <?php echo trans("previous"); ?></a>
            <?php endif; ?>
            <?php if ($gallery_post_item_order < $gallery_post_total_item_count): ?>
                <a href="<?php echo post_url($post); ?>/<?php echo($gallery_post_item_order + 1); ?>" class="btn btn-custom btn-md pull-right"><?php echo trans("next"); ?>&nbsp;<i class="icon-arrow-right"></i></a>
            <?php endif; ?>
        </div>
    </div>
<?php endif; ?>
