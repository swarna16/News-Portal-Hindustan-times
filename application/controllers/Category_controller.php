...
class Category_controller extends Admin_Core_Controller
{
    ...
    public function subcategories()
    {
        ...
        $data['top_categories'] = $this->category_model->get_top_categories_by_lang($this->selected_lang->id);
        $data['lang_search_column'] = 2;
    ...
    public function update_subcategory($id)
    {
        ...
        $data['top_categories'] = $this->category_model->get_top_categories_by_lang($data['category']->lang_id);
